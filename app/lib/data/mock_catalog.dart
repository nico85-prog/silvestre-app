...
class MockCatalog {
  ...
  static final List<Product> products = [
    Product(
      ...
      description: 'Carta fotografica professionale, finitura lucida o opaca. Pi\u00f9 stampi meno paghi.',
      basePrice: 0.45,
    ...
    Product(
      ...
      description: 'Stampe da 20x25 a 30x45. Pi\u00f9 stampi meno paghi.',
      basePrice: 1.9,
      icon: Icons.photo_outlined,
      editorConfig: const EditorConfig(canvasWidthMm: 200, canvasHeightMm: 200),
      variants: [
    ...
    Product(
      ...
      description: 'Formati allungati per panorami e foto di gruppo.',
      basePrice: 2.0,
