...
table(doc,
      ...
      [
          ...
          ["1", "Stripe LIVE (PIVA + chiavi)", "Senza Stripe LIVE i pagamenti con carta sono in modalità test: nessun soldo arriva sul tuo conto. Necessario per ricevere ordini con pagamento online.", "~1.4% + 0,25\u20ac/tx", "1-2 gg"],
          ["1", "Satispay Business LIVE", "Satispay è popolare in Italia, soprattutto sotto i 40 anni. Senza account LIVE non puoi accettare questi pagamenti — perdi una fascia di clienti.", "~1.5%/tx", "7 gg"],
          ["1", "WhatsApp Business sul negozio", "CANALE PRIMARIO di notifica al cliente. In fase di registrazione il telefono è obbligatorio: appena l'ordine è pronto, l'operatore manda un WhatsApp con un click. Funziona già nell'app (deep link), serve solo attivare WA Business sul numero negozio per professionalità.", "GRATIS", "15 min"],
          ["1", "Iubenda Privacy + Termini + Cookie GDPR", "Per legge, app che raccolgono email e dati personali DEVONO avere Privacy Policy e Cookie banner conformi GDPR. Senza, multa fino a 20.000\u20ac e impossibilità di pubblicare su App Store/Play.", "29-80\u20ac/anno", "30 min"],
          ["1", "Beta test con 5-10 conoscenti", "Bug ovvi per loro che noi non vediamo. Una settimana di test reale prima del lancio evita figure brutte con clienti veri.", "GRATIS", "1-2 sett."],
          ["2", "Sentry monitoring errori", "Quando l'app crasha o un cliente vede un bug, oggi non lo sai. Sentry ti manda email con dettaglio errore — risolvi prima che 10 clienti lo subiscano.", "GRATIS 5000/mese", "1 h"],
          ["2", "Backup Firestore notturno", "Se qualcuno cancella per sbaglio un ordine o gli account, oggi non recuperi niente. Cloud Function che esporta ogni notte = sicurezza zero perdita dati.", "GRATIS", "2 h"],
          ["2", "Bottone WhatsApp + mappa Google", "Il cliente vuole chiamare/vedere dove sei? Oggi deve cercare. Bottoni in app riducono attriti per ritiro/contatto.", "GRATIS", "1 h"],
          ["2", "Aruba/FattureInCloud", "La normativa italiana richiede fatturazione elettronica anche per B2C oltre soglia. Senza, sanzioni e impossibilità di lavorare con aziende.", "25-50\u20ac/anno", "1 h"],
          ["2", "SendGrid email (opzionale)", "WhatsApp è il canale principale (vedi Tier 1). SendGrid serve solo per cose che WhatsApp non può fare bene: ricevuta PDF allegata, recupero password, newsletter promo, comunicazioni lunghe e formali.", "GRATIS 100/gg", "2 h"],
          ["3", "Apple Developer", "Per pubblicare sull'App Store iPhone è obbligatorio. Senza, gli utenti iOS possono solo aggiungere la PWA a Safari — limitazione marketing.", "99$/anno", "2 sett."],
          ["3", "Google Play Developer", "Per essere su Play Store Android serve. La maggior parte degli utenti scarica solo da Play Store, non dal browser.", "25$ una tantum", "3 sett."],
          ["3", "Build + submission iOS/Android", "Convertire la PWA in app native è automatico ma serve build + screenshot + descrizioni store. Una volta fatto, è ripetibile a ogni aggiornamento.", "GRATIS", "3-5 gg"],
          ["3", "Google Analytics 4 + fedeltà + newsletter", "Capire dove i clienti si bloccano + premiare ricorrenti + comunicare offerte. Aumenta retention e ordini ripetuti.", "GRATIS", "1 gg"],
          ["3", "Multilingua EN + accessibilità", "Per turisti stranieri (campagna, casertano, NA) e clienti con disabilità. Allarga il bacino.", "GRATIS", "1-2 gg"],
          ["3", "Polizze RC + Cyber + GDPR audit", "Se un cliente fa causa per ordine sbagliato o perdita dati, la polizza copre. Audit annuale tiene il GDPR aggiornato.", "700-1500\u20ac/anno", "1 h"],
      ])
...
bul(doc, [
    "Auth Firebase + telefono obbligatorio + 3 ruoli (customer/staff/admin)",
    "Catalogo 30 prodotti / 193 varianti con tutte le fasce qty",
    "Carrello + ordini real-time + photobook auto-impagina + lavoro personalizzato",
    "Operatore con messaggi WhatsApp/SMS/Email cliente, preventivi, dashboard",
    "PWA installabile iOS/Android + tema personalizzabile",
    "CI/CD GitHub Actions auto-deploy + workflow refresh immagini",
    "Persistenza dati garantita (account/ordini MAI resettati ai deploy)",
])
